...
export default function ReporteSatisfaccionPage() {
  ...
  const exportarPDF = async () => {
    ...
    try {
      ...
      doc.text('Reporte de Satisfacción del Cliente (Evaluación del Servicio)', 14, 18);
      doc.setFontSize(9); doc.setFont('helvetica', 'normal');
      doc.text(`Generado: ${new Date().toLocaleString('es-PE')}  |  Total Evaluaciones: ${reportData.resumen.total_evaluaciones}  |  Calificación Promedio: ${reportData.resumen.promedio_calificacion}/5.0  |  Nivel Satisfacción: ${reportData.resumen.porcentaje_satisfaccion}%`, 14, 26);
